...
@media (max-width: 900px){
  ...
  .st-emotion-cache-10trblm, .st-emotion-cache-16idsys, .st-emotion-cache-q8sbsg {
    color:#0f172a !important;
  ...
  .stSelectbox svg, .stNumberInput button svg {
  ...
  /* toggles */
  [data-testid="stWidgetLabel"] p { color:#0f172a !important; -webkit-text-fill-color:#0f172a !important; }
  ...
  div[data-testid="stExpanderDetails"] div[data-baseweb="input"] > div,
  div[data-testid="stExpanderDetails"] div[data-baseweb="base-input"] > div {
    background:#ffffff !important;
    color:#0f172a !important;
    -webkit-text-fill-color:#0f172a !important;
  }
  ...
  .event-box *, .scanner-event-strip *, div[data-testid="stAlert"] * {
    color:#0f172a !important;
    -webkit-text-fill-color:#0f172a !important;
  }

  /* mobile cards keep dark card but readable */
  .scanner-card, .scanner-panel {
    background-image:linear-gradient(180deg, #04132d 0%, #081a3a 100%) !important;
  }
  .scanner-card *, .scanner-panel * {
