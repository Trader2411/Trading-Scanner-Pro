...
@media (max-width: 900px){
  ...
  .scanner-panel{ padding:9px 10px !important; border-radius:14px !important; }
  .scanner-panel-label{ font-size:0.62rem !important; margin-bottom:0.25rem !important; }
  .scanner-panel-row{ font-size:0.66rem !important; line-height:1.25 !important; margin:0.12rem 0 !important; }
  .scanner-panel-row span{ font-size:0.60rem !important; }
  ...
  .scanner-event-strip{ font-size:0.68rem !important; padding:0.5rem 0.6rem !important; border-radius:10px !important; }
  .scanner-meta-caption{ font-size:0.62rem !important; margin-left:0.05rem !important; }
  div.stButton > button{
  ...
  .mobile-portfolio-list{ display:flex; flex-direction:column; gap:8px; margin:0.45rem 0 0.7rem 0; }
...
if not portfolio_signal_df.empty:
    ...
    render_portfolio_signal_cards(portfolio_signal_df)
